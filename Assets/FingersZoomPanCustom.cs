...
namespace DigitalRubyShared
{
    ...
    public class FingersZoomPanCustom : MonoBehaviour
    {
        ...
        private void LateUpdate()
        {
            ...
            transform.localPosition = pos + (velocity * Time.deltaTime);
            velocity *= Dampening;
        }
        ...
        private void PanGesture_Updated(DigitalRubyShared.GestureRecognizer gesture)
        {
            if (PanGesture.State == GestureRecognizerState.Executing)
            {
                ...
                float tmp = panInWorldSpace.y;
                panInWorldSpace.y = panInWorldSpace.z;
                panInWorldSpace.z = tmp;
                //Debug.Log(PanGesture.DeltaX + " " + PanGesture.DeltaY);
                _camera.transform.Translate(panInWorldSpace,Space.Self);
            }
