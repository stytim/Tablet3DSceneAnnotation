...
namespace DigitalRubyShared
{
    ...
    public class FingersImageGestureHelperComponentScript : ImageGestureRecognizerComponentScript
    {
        ...
        /// <summary>
        /// Start lines animating out
        /// </summary>
        public void BeginAnimateOutLines()
        {
        ...
        /// </summary>
        /// <param name="reset">True to reset the gesture (required to check for new images, false if you will reset it later)</param>
        /// <returns>Matched image or null if none</returns>
        public ImageGestureImage CheckForImageMatch(bool reset = true)
        {
