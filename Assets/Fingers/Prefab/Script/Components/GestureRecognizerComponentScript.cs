...
namespace DigitalRubyShared
{
    ...
    public abstract class GestureRecognizerComponentScript<T> : GestureRecognizerComponentScriptBase where T : DigitalRubyShared.GestureRecognizer, new()
    {
        ...
        {
            if (AllowSimultaneousExecutionWith == null)
            {
                AllowSimultaneousExecutionWith = new List<GestureRecognizerComponentScriptBase>();
            }
            if (RequireGestureRecognizersToFail == null)
            {
                RequireGestureRecognizersToFail = new List<GestureRecognizerComponentScriptBase>();
            }
            ...
            if (gesture == null)
            {
                ...
                StartCoroutine(SetupGestureInteractions());
            }
        ...
        private IEnumerator SetupGestureInteractions()
        {
